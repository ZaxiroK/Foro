...
namespace Foro.Controllers
{
    public class ClientController : Controller
    {
        ...
        public ClientController(MvcContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,IdentityCard,WebPage,Address,Phone,Sector")] Client client)
        {
            if (id != client.ID)
            {
                return NotFound();
